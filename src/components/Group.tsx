      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Paper>
            ...
            <EntriesTable
              entries={groupStore.entriesForList}
              columns={[EColumn.TYPE, EColumn.TITLE, EColumn.SUBJECT, EColumn.STARRED, EColumn.EDIT, EColumn.CREATED, EColumn.UPDATED, EColumn.REQUESTED]}
            />
          </Paper>
        </Grid>
      </Grid>
